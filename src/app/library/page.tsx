...
export const metadata = {
  ...
  description: "120 distilled frameworks from Brené Brown, Oprah Winfrey, Andrew Huberman, and Diary of a CEO.",
};
    ...
    <div>
      <div className="mb-10">
        ...
        <p className="text-[#7A6655] max-w-xl">
          120 distilled frameworks from four transformational thinkers. Search, filter, and dive
